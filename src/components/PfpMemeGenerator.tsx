...
export default function PfpMemeGenerator() {
  ...
  return (
    <div id="meme" className="min-h-screen pt-[4rem] md:pt-[8rem] bg-gradient-to-b from-[#060b2e] to-[#03020a] text-black dark:text-white flex flex-col items-center justify-start px-4 py-10">
